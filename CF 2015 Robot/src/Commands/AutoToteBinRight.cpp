...
AutoToteBinRight::AutoToteBinRight(double wait) {
	...
	AddSequential(new DriveRotate(180, Drive::fMark, 0.5));
	AddSequential(new DriveDistance(-18, 0.5, true, true, 180, Drive::fMark));
}
